...
namespace UnitTest
{
	...
	TEST(RangeQuery, Simple2D)
	{
		...
		sort(v.begin(), v.end());
		ASSERT_EQ(vector<Point2>({ {1,1}, {1,5}, {2,5}, {2,7}, {3,8}, {4,4}, {4,6}, {6,1} }), v);
	}
	TEST(RangeQuery, Duplicates2D)
	{
		...
		sort(v.begin(), v.end());
		ASSERT_EQ(vector<Point2>({ {1,1}, {1,1}, {1,1}, {1,5}, {1,5}, {1,5}, {2,5}, {2,5}, {2,5},
	...
	TEST(RangeQuery, Simple3D)
	{
		...
		sort(v.begin(), v.end());
		ASSERT_EQ(vector<Point3>({ {1,1.5,5}, {1,5,4}, {2.5,5.5,1}, {2.5,7,6}, {3,8,3}, {4,4,7}, {4,6,4.5}, {6,1,2} }), v);
	}
